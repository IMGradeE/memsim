#ifndef CHALLENGE6_LIBRARY_H
#define CHALLENGE6_LIBRARY_H
...
int get_physical_address(unsigned int virtual_address,
...
int read_value(int virtual_address,
               int page_mask,
               int page_table_loc,
               int* physical_memory);
